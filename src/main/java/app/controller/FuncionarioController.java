...
public class FuncionarioController {
	...
	public ResponseEntity<List<Funcionario>> findByNmFuncionario(@RequestParam String nmFuncionario){
		
		try {
			List<Funcionario> lista = this.funcionarioservice.findByNmFuncionario(nmFuncionario);
			return new ResponseEntity<>(lista, HttpStatus.OK);
			//rever
		} catch (Exception e) {
			return new ResponseEntity<>(null, HttpStatus.OK);
